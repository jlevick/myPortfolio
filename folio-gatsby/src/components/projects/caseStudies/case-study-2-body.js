        ...
        <Container>
          ...
          <Section>
            ...
            <Row className="mt-5">
              ...
              <Row className='mt-5'>
                <div>
                  <Text className="mb-4 mt-4">Once I felt more comfortable with the various data types, I used my newfound knowledge to create a hamburger menu for mobile. </Text>
                </div>
              </Row>
              <Row className='mt-5'>
                <Col>
          ...
          <Section>
            ...
            <Row className='mt-5'>
              <Text className="mb-4 mt-4">To test the error handling in my JavaScript file I intentionally introduced random text. As expected, an error message was displayed, "unexpected keyword or identifier".</Text>
            </Row>
            <Row className='mt-5'>
              <Col>
            ...
            <Row className='mt-5'>
              <div>
                <Text className="mb-4 mt-4">Eventually I discovered I had a single extra opening &lt;div&gt;, explaining why I was not able to locate the error during my first look through. After deletion, I was error free. </Text>
              </div>
            </Row>
            <Row className='mt-5'>
              <Col>
