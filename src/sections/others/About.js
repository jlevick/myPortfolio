          ...
          <Row>
            <div className="pl-lg-4 pt-5 pt-lg-0">
              <Text
                ...
                `}
              >
                Hi - I'm Jaime, a UX writer with front-end development skills and a knack for simplifying complex jargon. 
                <br />
                <br /> <b>How I can help</b>
                <br />
                <li><b>UX writing</b>: exploring and integrating data to write clear, consistent, contextual copy</li>
                ...
                <li><b>Development communication</b>: working with dev teams to create inclusive solutions and less painful hand-offs</li>
                <br />
                <b>Nice things people have said about working with me:</b>
                <br />
