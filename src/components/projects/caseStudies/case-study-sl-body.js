        ...
        <Container>
          ...
          <Section>
            ...
            <Row className='mt-4'>
                  ...
                  <Text className="mb-4 mt-4">Completing a background check as soon as possible is an important step in mentorship approval, however <b>3 out of 6</b> mentors <b>wouldn't choose to complete their background check first</b>. <br /> <br /> Users were more likely to complete their profile prior to initiating their background check, and it might be worth using this knowledge in proposing a solution. I'm not certain changing copy alone is the best solution, abd <b>my recommendation</b> is to get more folks involved to brainstorm around hypotheses and possible solutions. It could be that copy such as <i>"Initiate your background check and complete your profile while you wait"</i> would help, or it might be the design needs adjusted and an explicit step-by-step for mentorship approval needs to be created. Or it could be something else entirely!</Text>
                  <Title variant="cardBig">More information needed</Title>
                  <Text className="mb-4 mt-4"><b>4 out of 6</b> mentors wanted to know <b>what data would be checked</b> and <b>what would make them ineligible to be a mentor</b>. I was not surprised by these findings as we too were unclear on the totality of the background check process. <br /> <br /> <b>My recommendation</b> is to set up a meeting with the client at the start of Phase 3 to discuss any new information they may have regarding which 3rd party vendor will be conducting the background checks. Conducting further research on what qualfiies and disqualifies applicants will be useful. Ultimately more information is needed internally to effectively propose any useful changes. Once the writers are clear on the information themselves, they will be able to craft their copy for increased clarity.</Text>
